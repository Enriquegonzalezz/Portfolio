...
import { AnimatedBeam } from "@/components/sintesiscomp/magicui/animatede-beam"
...
export default function AnimatedBeamDemo() {
  ...
  <div className="flex size-full max-h-full w-full flex-col items-stretch justify-between gap-10">
    {/* Fila superior - más espacio */}
    ...
    {/* Fila del media - más ancha */}
    <div className="flex w-full flex-1 flex-row items-center justify-between px-20">
      <Circle ref={div2Ref}>
        <img src="./Ts.png" alt="" className="w-28 rounded-3xl aspect-square  scale-90  h-auto " />
      </Circle>
      <Circle ref={div4Ref} className="size-16">
      <img src="./edeta.jpg" alt="" className="w-28 rounded-full aspect-square h-auto " />
      </Circle>
      <Circle ref={div6Ref}>
      <img src="./fotoreact.png" alt="" className="w-28 rounded-full aspect-square h-auto scale-110 " />
      </Circle>
    </div>
    
    {/* Fila inferior - más espacio */}
    <div className="flex w-full flex-row items-center justify-between px-10">
      <Circle ref={div3Ref}>
      <img src="./fotonext.png" alt="" className="w-28 rounded-full aspect-square h-auto " />
      </Circle>
      <Circle ref={div7Ref}>
      <img src="./fotocss.png" alt="" className="w-32 rounded-full aspect-square -rotate-[45deg] h-auto scale-125 " />
      </Circle>
    </div>
  </div>

  {/* Beams - asegurar z-index y curvatura visible */}
  <AnimatedBeam 
